...
import type { JoinRequestItem, MySentInvitationItem } from '@/api/rag/group'
          ...
          <table class="glass-table">
            ...
            <tbody>
              <tr v-for="req in items" :key="req.requestId">
                ...
                <td class="time-cell">{{ formatDate(req.createTime) }}</td>
                <td>
          ...
          <table class="glass-table">
            ...
            <tbody>
              <tr v-for="inv in sentInvitations" :key="inv.invitationId">
                ...
                <td class="time-cell">{{ formatDate(inv.createTime) }}</td>
                <td>
